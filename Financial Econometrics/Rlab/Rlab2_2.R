...
par(mfrow=c(1,1))
resid1 = rstudent(fitLm1)##²Ð²î±ê×¼»¯
plot(fitLm1$fit,resid1,ylim=c(-100,100),main="(a)")
abline(h=0,col="blue",lwd=5)


plot(fitLm1$fit,abs(resid1),ylim=c(0,100),main="(b)")
...
plot(education,resid1,ylim=c(-10,50),main="(d)")
lines(lowess(education,resid1),lwd=5,col="red")
abline(h=0,col="blue",lwd=5)

plot(experience,resid1,ylim=c(-100,150),main="(e)")
